...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sweep_variable.addItem("")
        self.sweep_variable.addItem("")
        self.gridLayout_9.addWidget(self.sweep_variable, 2, 0, 1, 1)
        ...
        self.gridLayout_15.addLayout(self.gridLayout_10, 0, 1, 2, 1)
        ...
        self.gridLayout_15.addLayout(self.gridLayout_11, 1, 0, 2, 1)
        ...
        self.gridLayout_15.addLayout(self.gridLayout_13, 2, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.operator_name.setItemText(9, _translate("MainWindow", "L2"))
        self.operator_name.setItemText(10, _translate("MainWindow", "S2"))
        self.operator_name.setItemText(11, _translate("MainWindow", "J2"))
        self.operator_name.setItemText(12, _translate("MainWindow", "x2"))
        self.operator_name.setItemText(13, _translate("MainWindow", "y2"))
        self.operator_name.setItemText(14, _translate("MainWindow", "z2"))
        ...
        self.label_3.setText(_translate("MainWindow", "z^2 [eV]"))
        ...
        self.label_4.setText(_translate("MainWindow", "x^2-y^2 [eV]"))
        self.label_5.setText(_translate("MainWindow", "x^4+y^4+z^4"))
        self.label_7.setText(_translate("MainWindow", "z^4 [eV]"))
        self.label_6.setText(_translate("MainWindow", "(x+y+z)^2"))
        ...
        self.label_11.setText(_translate("MainWindow", "x^2y^2"))
