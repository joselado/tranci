...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sweep_variable.setItemText(4, _translate("MainWindow", "x^2y^2"))
        self.sweep_variable.setItemText(5, _translate("MainWindow", "x^4+y^4+z^4"))
        self.sweep_variable.setItemText(6, _translate("MainWindow", "(x+y+z)^2"))
        self.sweep_variable.setItemText(7, _translate("MainWindow", "B"))
        self.sweep_variable.setItemText(8, _translate("MainWindow", "theta_B"))
        self.sweep_variable.setItemText(9, _translate("MainWindow", "phi_B"))
        self.sweep_variable.setItemText(10, _translate("MainWindow", "J"))
        self.sweep_variable.setItemText(11, _translate("MainWindow", "theta_J"))
        self.sweep_variable.setItemText(12, _translate("MainWindow", "phi_J"))
        self.sweep_variable.setItemText(13, _translate("MainWindow", "U"))
